...
export type Apartment = Node & {
  ...
  airbnb?: Maybe<Scalars["String"]["output"]>;
  color?: Maybe<Color>;
...
export type ApartmentCreateInput = {
  ...
  airbnb?: InputMaybe<Scalars["String"]["input"]>;
...
export type ApartmentManyWhereInput = {
  ...
  airbnb?: InputMaybe<Scalars["String"]["input"]>;
  /** All values containing the given string. */
  airbnb_contains?: InputMaybe<Scalars["String"]["input"]>;
  /** All values ending with the given string. */
  airbnb_ends_with?: InputMaybe<Scalars["String"]["input"]>;
  /** All values that are contained in given list. */
  airbnb_in?: InputMaybe<Array<InputMaybe<Scalars["String"]["input"]>>>;
  /** Any other value that exists and is not equal to the given value. */
  airbnb_not?: InputMaybe<Scalars["String"]["input"]>;
  /** All values not containing the given string. */
  airbnb_not_contains?: InputMaybe<Scalars["String"]["input"]>;
  /** All values not ending with the given string */
  airbnb_not_ends_with?: InputMaybe<Scalars["String"]["input"]>;
  /** All values that are not contained in given list. */
  airbnb_not_in?: InputMaybe<Array<InputMaybe<Scalars["String"]["input"]>>>;
  /** All values not starting with the given string. */
  airbnb_not_starts_with?: InputMaybe<Scalars["String"]["input"]>;
  /** All values starting with the given string. */
  airbnb_starts_with?: InputMaybe<Scalars["String"]["input"]>;
  createdAt?: InputMaybe<Scalars["DateTime"]["input"]>;
  ...
  mapLink?: InputMaybe<Scalars["String"]["input"]>;
  /** All values containing the given string. */
  mapLink_contains?: InputMaybe<Scalars["String"]["input"]>;
  /** All values ending with the given string. */
  mapLink_ends_with?: InputMaybe<Scalars["String"]["input"]>;
  /** All values that are contained in given list. */
  mapLink_in?: InputMaybe<Array<InputMaybe<Scalars["String"]["input"]>>>;
  /** Any other value that exists and is not equal to the given value. */
  mapLink_not?: InputMaybe<Scalars["String"]["input"]>;
  /** All values not containing the given string. */
  mapLink_not_contains?: InputMaybe<Scalars["String"]["input"]>;
  /** All values not ending with the given string */
  mapLink_not_ends_with?: InputMaybe<Scalars["String"]["input"]>;
  /** All values that are not contained in given list. */
  mapLink_not_in?: InputMaybe<Array<InputMaybe<Scalars["String"]["input"]>>>;
  /** All values not starting with the given string. */
  mapLink_not_starts_with?: InputMaybe<Scalars["String"]["input"]>;
  /** All values starting with the given string. */
  mapLink_starts_with?: InputMaybe<Scalars["String"]["input"]>;
...
export type AssetManyWhereInput = {
  ...
  label?: InputMaybe<PhotoLabels>;
  /** All values that are contained in given list. */
  label_in?: InputMaybe<Array<InputMaybe<PhotoLabels>>>;
  /** Any other value that exists and is not equal to the given value. */
  label_not?: InputMaybe<PhotoLabels>;
  /** All values that are not contained in given list. */
  label_not_in?: InputMaybe<Array<InputMaybe<PhotoLabels>>>;
...
export enum PhotoLabels {
  ...
  GalleryCoversSmall = "gallery_covers_small",
  Howto = "howto",
}
